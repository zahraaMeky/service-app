      ...
      <Image src={business.image[0].url}
        ...
        <div className='md:flex items-center justify-between w-full'>
          <div className='flex flex-col items-baseline gap-3 mt-4 md:mt-0'>
            <h2 className="p-1 bg-purple-200 text-purple-700 rounded-full regular-14 px-3">{business?.category?.name}</h2>
          ...
          <div className='flex flex-col gap-5 items-end'>
            <Button className='bg-purple-400 text-white'><Share/></Button>
